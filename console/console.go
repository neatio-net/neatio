...
// Welcome show summary of current neatio instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic neatio metadata
	fmt.Fprintf(c.printer, "Welcome to the Neatio JavaScript console!\n\n")
	c.jsre.Run(`
