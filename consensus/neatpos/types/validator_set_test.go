...
var valList = []*val{
	{
		Address:     "NEATgwDBd2HzToG6qaYd2RAYQeKqd95b",
	...
	{
		Address:     "NEATcNpdUddxyPsp4AWiXVvfDK3LqrTD",
	...
	{
		Address:     "NEATgJ4x3mbYsVSKAws4v8N2nfHHanfn",
...
func TestValidatorSet_Hash(t *testing.T) {
	...
	// The validator is reordered and should not be used
