...
import (
	...
	"github.com/neatlab/neatio/accounts/usbwallet"
...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of neatio is "neatio". If no
...
func (c *Config) NodeName() string {
	...
	//if name == "neatio" || name == "neatio-testnet" {
	//	name = "neatio"
	//}
	if c.UserIdent != "" {
		name += "/" + c.UserIdent
...
// These resources are resolved differently for "neatio" instances.
