...
func TestConsoleWelcome(t *testing.T) {
	...
	// Start a neatio console, make sure it's cleaned up and terminate the console
	neatio := runneatio(t,
...
func testAttachWelcome(t *testing.T, neatio *testneatio, endpoint, apis string) {
	// Attach to a running neatio note and terminate immediately
	attach := runneatio(t, "attach", endpoint)
