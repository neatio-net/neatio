...
import (
	...
	"github.com/neatlab/neatio/internal/cmdtest"
)
...
func init() {
	// Run the app if we've been exec'd as "neatio-test" in runneatio.
...
func runneatio(t *testing.T, args ...string) *testneatio {
	tt := &testneatio{}
