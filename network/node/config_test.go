...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "neatio.ipc", false, filepath.Join(os.TempDir(), "neatio.ipc")},
		{"data", "neatio.ipc", false, "data/neatio.ipc"},
		{"data", "./neatio.ipc", false, "./neatio.ipc"},
		{"data", "/neatio.ipc", false, "/neatio.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "neatio.ipc", true, `\\.\pipe\neatio.ipc`},
		{"data", "neatio.ipc", true, `\\.\pipe\neatio.ipc`},
		{"data", `\\.\pipe\neatio.ipc`, true, `\\.\pipe\neatio.ipc`},
	}
