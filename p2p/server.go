...
// Package p2p implements the Neatio p2p network protocols.
package p2p
...
type Config struct {
	...
	// Should find nodes for all of them to support bls transport in NeatPoS module
...
// AddHandshakeCaps Add the Child Protocol Caps after create the side chain and before launch it
func (srv *Server) AddSideProtocolCaps(sideProtocols []Protocol) {
