...
const (
	...
	// NeatChain message belonging to neatio/64
...
func (p *Peer) checkAndUpdateProtocol(chainId string) bool {
	...
	childProtocolName := "neatio_" + chainId
	...
	p.log.Infof("No Local Server Protocol matched, perhaps local server has not start the side chain %v yet.", childProtocolName)
	return false
}
